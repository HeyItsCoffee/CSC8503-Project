...
namespace NCL {
	...
	public:
		...
		static Ray BuildRayFromObjectFacing(GameObject& object);
		...
		static bool AABBFullyWithin(const Vector3& posA, const Vector3& posB, const Vector3& halfSizeA, const Vector3& halfSizeB);
