...
void NetworkObject::UpdateLastFullState() {
	...
	lastFullState.velocity = object->GetPhysicsObject()->GetLinearVelocity();
	lastFullState.angVelocity = object->GetPhysicsObject()->GetAngularVelocity();
}
...
bool NetworkObject::ReadFullPacket(FullPacket &p) {
	...
	object->GetPhysicsObject()->SetAngularVelocity(lastFullState.angVelocity);
